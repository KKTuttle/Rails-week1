...
group :development, :test do  # Call 'byebug' anywhere in the code to stop execution and get a debugger console  gem 'byebug', platform: :mri  gem 'rspec-rails'  gem 'launchy'  gem 'pry'  gem 'capybara'  gem 'shoulda-matchers'  gem 'factory_girl_rails'  gem 'simplecov', :require => false
end
